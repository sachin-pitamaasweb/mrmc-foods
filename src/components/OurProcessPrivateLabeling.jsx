                    ...
                    <div className="our-process-img-grid-div">
                        {processStepsData.map((step, index) => (
                            <Grid item xs={12} key={index} className="our-process-grid">
                                <img src={step.image} alt={step.title} className="our-process-img" data-aos="fade-right" data-aos-duration="2000" />
                                {(window.innerWidth >= 320 && window.innerWidth < 500 && (index !== processStepsData.length - 1)) && (
                                    <div className="our-process-icon-div" >
                                        <TrendingFlatIcon className="our-process-icon"  data-aos="fade-up" data-aos-duration="2000" />
                                    </div>
                                )}
                                ...
                                <Typography variant="h5" gutterBottom align="center" className="our-process-h5" data-aos="fade-right" data-aos-duration="2000" >
                                    {step.title}
                                </Typography>
                            </Grid>
                        ))}
