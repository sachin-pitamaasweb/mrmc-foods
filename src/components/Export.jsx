            ...
            <Grid container spacing={2} className="export-grid-container">
                <Grid container spacing={2} className="export-grid-text">
                    <Grid item xs={12} md={4} lg={4}>
                        <img src={require('../assets/images/flag.png')} alt="flag" className="flag" data-aos="zoom-in-down"  data-aos-duration="3000" />
                    ...
                    <Grid item xs={12} md={8} lg={8} data-aos="zoom-in-down" data-aos-duration="3000">
