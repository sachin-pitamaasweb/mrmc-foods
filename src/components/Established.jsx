    ...
    return (
        <>
            <Grid container className="established" spacing={2}>
                ...
                <Grid item xs={12} lg={6} md={6} data-aos="zoom-in-down" data-aos-duration="1000">
                    <img src={require('../assets/images/Established.png')} alt="Established" className="established-img" />
                </Grid>
                <Grid item xs={12} lg={6} md={6}>
                    <h3 className="established-h3" data-aos="fade-up-left" data-aos-duration="1000">
                        Established in 2000
                    </h3>
                    <p className="established-p" data-aos="fade-left" data-aos-duration="1000">
                    ...
                    <div className="cft-div">
                        <img src={require('../assets/images/cft.png')} alt="cft" className="cft" data-aos="zoom-in-down" data-aos-duration="1000" />
                    </div>
                </Grid>
            </Grid>
        </>
