...
export const testimonialsData = [
  {
    ...
    name: 'Arjun Rathore',
    description: `MRMC FOODS has been the cornerstone of our business success. Their wide range of basmati rice varieties reflects the rich tapestry of Indian culture and tradition. The quality and consistency of their products are unparalleled, making them the go-to choice for discerning consumers like us. We are proud to be
        associated with MRMC and look forward to many more years of fruitful collaboration`
  },
  {
    src: 'images/test2.jpg',
    name: 'Meera Kapoor',
    description: `MRMC FOODS has been our culinary lifeline. Their unwavering dedication to quality basmati rice varieties has elevated our dishes to new heights. As a chef, sourcing reliable ingredients is crucial, and MRMC consistently delivers. Their rice transports our customers to the heart of India with every bite. We're grateful for their partnership`
  },
  {
...
export const carouselItemsforMobile = [
  {
    src: require('./assets/images/Carousel/banner-for-mobile.jpg'),
    alt: "Carousel-Image"
  },
  {
    src: require('./assets/images/Carousel/banner-for-mobile1.png'),
    alt: "Carousel-Image"
  },
  {
    src: require('./assets/images/Carousel/banner-for-mobile2.jpg'),
    alt: "Carousel-Image"
  },
  {
    src: require('./assets/images/Carousel/banner-for-mobile3.png'),
    alt: "Carousel-Image"
  },
]
...
export const carouselItemsforDesktop = [
  {
    src: require('./assets/images/Carousel/Carousel-Image.jpg'),
    alt: "Carousel-Image"
  },
  {
    src: require('./assets/images/Carousel/Carousel-Image1.png'),
    alt: "Carousel-Image"
  },
  {
    src: require('./assets/images/Carousel/Carousel-Image2.jpg'),
    alt: "Carousel-Image"
  },
  {
    src: require('./assets/images/Carousel/Carousel-Image3.png'),
    alt: "Carousel-Image"
  },
]
...
export const eventGroups = [
  {
    ...
    events: [
      {
        image: require('./assets/images/events/ind/ind-1.png'),
        alt: 'Event 13',
        sm: 12,
        md: 5,
        lg: 5,
      ...
      {
        image: require('./assets/images/events/ind/ind-2.png'),
        alt: 'Event 14',
        sm: 12,
        md: 7,
        lg: 7,
      ...
      {
        image: require('./assets/images/events/ind/ind-3.png'),
        alt: 'Event 15',
        sm: 12,
        md: 4,
        lg: 4,
      ...
      {
        image: require('./assets/images/events/ind/ind-4.png'),
        alt: 'Event 16',
        sm: 12,
        md: 4,
        lg: 4,
      ...
      {
        image: require('./assets/images/events/ind/ind-5.png'),
        alt: 'Event 17',
        sm: 12,
        md: 4,
        lg: 4,
      ...
      {
        image: require('./assets/images/events/ind/ind-6.png'),
        alt: 'Event 18',
        sm: 12,
        md: 5,
        lg: 5,
      ...
      {
        image: require('./assets/images/events/ind/ind-7.png'),
        alt: 'Event 19',
        sm: 12,
        md: 7,
        lg: 7,
      ...
      {
        image: require('./assets/images/events/ind/ind-8.png'),
        alt: 'Event 20',
        sm: 12,
        md: 4,
        lg: 4,
      ...
      {
        image: require('./assets/images/events/ind/ind-9.png'),
        alt: 'Event 21',
        sm: 12,
        md: 8,
        lg: 8,
      ...
      {
        image: require('./assets/images/events/ind/ind-10.png'),
        alt: 'Event 22',
        sm: 12,
        md: 5,
        lg: 5,
      ...
      {
        image: require('./assets/images/events/ind/ind-11.png'),
        alt: 'Event 23',
        sm: 12,
        md: 7,
        lg: 7,
      ...
      {
        image: require('./assets/images/events/ind/ind-12.png'),
        alt: 'Event 24',
        sm: 12,
        md: 4,
        lg: 4,
      ...
      {
        image: require('./assets/images/events/ind/ind-13.png'),
        alt: 'Event 25',
        sm: 12,
        md: 4,
        lg: 4,
      ...
      {
        image: require('./assets/images/events/ind/ind-14.png'),
        alt: 'Event 26',
        sm: 12,
        md: 4,
        lg: 4,
      ...
      {
        image: require('./assets/images/events/ind/ind-15.png'),
        alt: 'Event 27',
        sm: 12,
        md: 5,
        lg: 5,
      ...
      {
        image: require('./assets/images/events/ind/ind-16.png'),
        alt: 'Event 28',
        sm: 12,
        md: 7,
        lg: 7,
      ...
      {
        image: require('./assets/images/events/ind/ind-17.png'),
        alt: 'Event 29',
        sm: 12,
        md: 5,
        lg: 5,
      ...
      {
        image: require('./assets/images/events/ind/ind-18.png'),
        alt: 'Event 30',
        sm: 12,
        md: 7,
        lg: 7,
